...
set_property -dict {LOC AD42 } [get_ports qsfp0_refclk_clk_p] ; # MGTREFCLK1P_130 from SI5394B
set_property -dict {LOC AD43 } [get_ports qsfp0_refclk_clk_n] ; 


# 161.1328125 MHz MGT reference clock (from SI5394B)
create_clock -period 6.206 -name qsfp0_refclk [get_ports qsfp0_refclk_clk_p]

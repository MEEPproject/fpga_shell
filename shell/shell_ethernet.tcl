...
set ETHinitfile [dict get $ETHentry InitFile]
...
exec vivado -mode batch -nolog -nojournal -notrace -source ./ip/axi_ETH/tcl/gen_project.tcl
putmeeps "... Done."
update_ip_catalog -rebuild

source $g_root_dir/ip/axi_ETH/tcl/project_options.tcl

create_bd_cell -type ip -vlnv meep-project.eu:MEEP:axi_ETH:$g_ip_version axi_ETH_0
